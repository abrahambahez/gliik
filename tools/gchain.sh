#!/usr/bin/env bash
#
# gchain - Execute Gliik instructions with intelligent context selection
#
# Usage:
#   gchain <context-file> <instruction> [flags...]
#
# Example:
#   gchain context.md analyze_metrics --output report.md
#
...
if [ $# -lt 2 ]; then
    cat << 'EOF'
Usage: gchain <context-file> <instruction> [flags...]
